...
const Strategy = artifacts.require("AlpacaStrategyMainnet_BUSD");


// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("BSC Mainnet Alpaca BUSD", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IBEP20.at("0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56");
