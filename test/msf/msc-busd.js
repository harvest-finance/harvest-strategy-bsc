...
const Strategy = artifacts.require("MSFStrategyMainnet_MSC_BUSD");


// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("BSC Mainnet MonsterSlayer MSC/BUSD", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IBEP20.at("0xbCbF0C95C94798fFEF0e71A087a7E98F29D5C0Ee");
  ...
  async function setupBalance(){
    ...
    await addLiquidity(farmer1, msc, busd, farmerMscBalance, farmerBusdBalance);
