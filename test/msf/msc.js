...
const Strategy = artifacts.require("MSFStrategyMainnet_MSC");


// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("BSC Mainnet MonsterSlayer MSC", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IBEP20.at("0x8C784C49097Dcc637b93232e15810D53871992BF");
    console.log("Fetching Underlying at: ", underlying.address);
  }

  async function setupBalance(){
    await swapBNBToToken(farmer1, [wbnb, busdAddr, underlying.address], "100" + "000000000000000000");
