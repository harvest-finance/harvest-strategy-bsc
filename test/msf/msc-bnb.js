...
const Strategy = artifacts.require("MSFStrategyMainnet_MSC_BNB");


// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("BSC Mainnet MonsterSlayer MSC/BNB", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IBEP20.at("0x981DB69F2F2F96e0f08D6519BEFDa0B927C22190");
    console.log("Fetching Underlying at: ", underlying.address);
  }

  async function setupBalance(){
    msc = await IBEP20.at(mscAddr);
    await swapBNBToToken(farmer1, [wbnb, busdAddr, mscAddr], "100" + "000000000000000000");
    farmerMscBalance = await msc.balanceOf(farmer1);
    await addLiquidity(farmer1, "BNB", msc, "100" + "000000000000000000", farmerMscBalance);
