...
const Strategy = artifacts.require("MdexStrategyMainnet_ETH_BTCB");


// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("BSC Mainnet MDEX ETH/BTCB", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IBEP20.at("0x577d005912C49B1679B4c21E334FdB650E92C077");
  ...
  async function setupBalance(){
    ...
    await addLiquidityMdex(farmer1, eth, btcb, farmerEthBalance, farmerBtcbBalance);
