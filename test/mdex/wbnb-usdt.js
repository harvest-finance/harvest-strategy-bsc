...
const Strategy = artifacts.require("MdexStrategyMainnet_WBNB_USDT");


// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("BSC Mainnet MDEX WBNB/USDT", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IBEP20.at("0x09CB618bf5eF305FadfD2C8fc0C26EeCf8c6D5fd");
  ...
  async function setupBalance(){
    ...
    await addLiquidityMdex(farmer1, "BNB", usdt, "100" + "000000000000000000", farmerUsdtBalance);
