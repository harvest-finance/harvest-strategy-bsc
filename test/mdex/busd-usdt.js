...
const Strategy = artifacts.require("MdexStrategyMainnet_BUSD_USDT");


// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("BSC Mainnet MDEX BUSD/USDT", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IBEP20.at("0x62c1dEC1fF328DCdC157Ae0068Bb21aF3967aCd9");
  ...
  async function setupBalance(){
    ...
    await addLiquidityMdex(farmer1, usdt, busd, farmerUsdtBalance, farmerBusdBalance);
