...
const VaultMigratable_Pancake_ETH_BNB = artifacts.require("VaultMigratable_Pancake_ETH_BNB");
const VaultProxy = artifacts.require("VaultProxy");

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Pancake ETH_BNB Migration", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    // old underlying
    underlying = await IBEP20.at("0x70D8929d04b60Af4fb9B58713eBcf18765aDE422");
  ...
  before(async function() {
    ...
    newImplementation = await VaultMigratable_Pancake_ETH_BNB.new({
      gas: 5000000
    });

    vault = await Vault.at("0xE1f9A3EE001a2EcC906E8de637DBf20BB2d44633");
    vaultAsNewImplementation = await VaultMigratable_Pancake_ETH_BNB.at("0xE1f9A3EE001a2EcC906E8de637DBf20BB2d44633");
  ...
  describe("Happy path", function() {
    it("Upgrade must succeed and Farmer should earn money", async function() {
     ...
     await Utils.waitHours(13);
      ...
      console.log('amountEth', LiquidityRemoved.args[1].toString());
      ...
      eth = await IBEP20.at("0x2170Ed0880ac9A755fd29B2688956BD959F933F8");
      bnb = await IBEP20.at("0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c");
      const f00dETH = await eth.balanceOf(governance);
      const f00dBNB = await bnb.balanceOf(governance);

      console.log("f00dETH: ", f00dETH.toString());
