...
const VaultMigratable_Pancake_BELT_BNB = artifacts.require("VaultMigratable_Pancake_BELT_BNB");
const VaultProxy = artifacts.require("VaultProxy");

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Pancake BELT_BNB Migration", function() {
  let accounts;
  ...
  before(async function() {
    ...
    newImplementation = await VaultMigratable_Pancake_BELT_BNB.new({
      gas: 5000000
    });

    vault = await Vault.at("0xaD941e12544F49077fc6425CDa1871E11Cea5288");
    vaultAsNewImplementation = await VaultMigratable_Pancake_BELT_BNB.at("0xaD941e12544F49077fc6425CDa1871E11Cea5288");
  ...
  describe("Happy path", function() {
    it("Upgrade must succeed and Farmer should earn money", async function() {
     ...
     await Utils.waitHours(13);
      ...
      belt = await IBEP20.at("0xE0e514c71282b6f4e823703a39374Cf58dc3eA4f");
      bnb = await IBEP20.at("0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c");
      const f00dBELT = await belt.balanceOf(governance);
      const f00dBNB = await bnb.balanceOf(governance);

      console.log("f00dBELT: ", f00dBELT.toString());
