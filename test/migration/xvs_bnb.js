...
const VaultMigratable_Pancake_XVS_BNB = artifacts.require("VaultMigratable_Pancake_XVS_BNB");
const VaultProxy = artifacts.require("VaultProxy");

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Pancake XVS_BNB Migration", function() {
  let accounts;
  ...
  before(async function() {
    ...
    newImplementation = await VaultMigratable_Pancake_XVS_BNB.new({
      gas: 5000000
    });

    vault = await Vault.at("0x0bB94083d5718a8cb716faDc016187a0d6C99425");
    vaultAsNewImplementation = await VaultMigratable_Pancake_XVS_BNB.at("0x0bB94083d5718a8cb716faDc016187a0d6C99425");
  ...
  describe("Happy path", function() {
    it("Upgrade must succeed and Farmer should earn money", async function() {
     ...
     await Utils.waitHours(13);
      ...
      xvs = await IBEP20.at("0xcF6BB5389c92Bdda8a3747Ddb454cB7a64626C63");
      bnb = await IBEP20.at("0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c");
      const f00dXVS = await xvs.balanceOf(governance);
      const f00dBNB = await bnb.balanceOf(governance);

      console.log("f00dXVS: ", f00dXVS.toString());
