...
const VaultMigratable_Pancake_BDO_BNB = artifacts.require("VaultMigratable_Pancake_BDO_BNB");
const VaultProxy = artifacts.require("VaultProxy");

// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("Pancake BDO_BNB Migration", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    // old underlying
    underlying = await IBEP20.at("0x74690f829fec83ea424ee1F1654041b2491A7bE9");
  ...
  before(async function() {
    ...
    newImplementation = await VaultMigratable_Pancake_BDO_BNB.new({
      gas: 5000000
    });

    vault = await Vault.at("0xE604Fd5b1317BABd0cF2c72F7F5f2AD8c00Adbe1");
    vaultAsNewImplementation = await VaultMigratable_Pancake_BDO_BNB.at("0xE604Fd5b1317BABd0cF2c72F7F5f2AD8c00Adbe1");
  ...
  describe("Happy path", function() {
    it("Upgrade must succeed and Farmer should earn money", async function() {
     ...
     await Utils.waitHours(13);
      ...
      console.log('amountBdo', LiquidityRemoved.args[1].toString());
      ...
      bdo = await IBEP20.at("0x190b589cf9Fb8DDEabBFeae36a813FFb2A702454");
      bnb = await IBEP20.at("0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c");
      const f00dBDO = await bdo.balanceOf(governance);
      const f00dBNB = await bnb.balanceOf(governance);

      console.log("f00dBDO: ", f00dBDO.toString());
