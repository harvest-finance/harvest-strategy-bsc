...
const Strategy = artifacts.require("NeonicStrategyMainnet_NEON");


// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("BSC Mainnet Neonic NEON", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IBEP20.at("0x94026f0227cE0c9611e8a228f114F9F19CC3Fa87");
