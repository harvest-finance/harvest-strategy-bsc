...
const IValueLiquidRouter = artifacts.require("IValueLiquidRouter");
...
async function swapBNBToTokenValue(_farmer, _tokenTo, _path, _amountBNB) {
  router = await IValueLiquidRouter.at("0xb7e19a1188776f32E8C2B790D9ca578F2896Da7C");
  await router.swapExactETHForTokens(
    _tokenTo,
    0,
    _path,
...
async function addLiquidityValue(_farmer, _token0, _token1, _amount0, _amount1, _pair) {
  router = await IValueLiquidRouter.at("0xb7e19a1188776f32E8C2B790D9ca578F2896Da7C");
  if (_token0 == "BNB") {
    wrapBNB(_farmer, _amount0);
    _token0 = await IBEP20.at("0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c");
