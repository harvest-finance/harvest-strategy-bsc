...
const Strategy = artifacts.require("bDollarStrategyMainnet_BDO_BNB");


// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("BSC Mainnet bDollar BDO/BNB", function() {
  let accounts;
  ...
  async function setupBalance(){
    ...
    await swapBNBToToken(farmer1, [wbnb, busdAddr, bdo.address], "50" + "000000000000000000");
    farmerBDOBalance = await bdo.balanceOf(farmer1);
    await addLiquidity(farmer1, "BNB", bdo, "50" + "000000000000000000", farmerBDOBalance);
  ...
  before(async function() {
    ...
    await feeForwarder.setConversionPath(sbdoAddr, eth, [sbdoAddr, busdAddr, wbnb, eth], {from:governance});
