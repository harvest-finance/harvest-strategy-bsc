...
const Strategy = artifacts.require("VenusFoldStrategyV2Mainnet_ETH");
    ...
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        if (i>0) {
          ...
          console.log("Intended withdraw amount:", correspondingFarmerBalance.toFixed(), "ETH");
          ...
          console.log("Actual withdraw amount:  ", farmerBalance.minus(oldFarmerBalance).toFixed(), "ETH");
          ...
          console.log("New farmer balance:      ", farmerBalance.toFixed(), "ETH");
          console.log("------------------------");
        }
