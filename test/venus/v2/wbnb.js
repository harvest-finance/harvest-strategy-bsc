    ...
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        if (i>0) {
          ...
          console.log("Intended withdraw amount:", correspondingFarmerBalance.toFixed(), "WBNB");
          ...
          console.log("Actual withdraw amount:  ", farmerBalance.minus(oldFarmerBalance).toFixed(), "WBNB");
          ...
          console.log("New farmer balance:      ", farmerBalance.toFixed(), "WBNB");
          console.log("------------------------");
        }
