...
const Strategy = artifacts.require("VenusFoldStrategyV2Mainnet_BTCB");


// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("BSC Mainnet Venus BTCB", function() {
  let accounts;
    ...
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        if (i>0) {
          ...
          console.log("Intended withdraw amount:", correspondingFarmerBalance.toFixed(), "BTCB");
          ...
          console.log("Actual withdraw amount:  ", farmerBalance.minus(oldFarmerBalance).toFixed(), "BTCB");
          ...
          console.log("New farmer balance:      ", farmerBalance.toFixed(), "BTCB");
          console.log("------------------------");
        }
