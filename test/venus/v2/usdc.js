...
const Strategy = artifacts.require("VenusFoldStrategyV2Mainnet_USDC");
    ...
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        if (i>0) {
          ...
          console.log("Intended withdraw amount:", correspondingFarmerBalance.toFixed(), "USDC");
          ...
          console.log("Actual withdraw amount:  ", farmerBalance.minus(oldFarmerBalance).toFixed(), "USDC");
          ...
          console.log("New farmer balance:      ", farmerBalance.toFixed(), "USDC");
          console.log("------------------------");
        }
