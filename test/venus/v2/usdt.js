...
const Strategy = artifacts.require("VenusFoldStrategyV2Mainnet_USDT");


// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("BSC Mainnet Venus USDT", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IBEP20.at("0x55d398326f99059fF775485246999027B3197955");
    ...
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        if (i>0) {
          ...
          console.log("Intended withdraw amount:", correspondingFarmerBalance.toFixed(), "USDT");
          ...
          console.log("Actual withdraw amount:  ", farmerBalance.minus(oldFarmerBalance).toFixed(), "USDT");
          ...
          console.log("New farmer balance:      ", farmerBalance.toFixed(), "USDT");
          console.log("------------------------");
        }
