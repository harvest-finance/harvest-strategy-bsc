...
const Strategy = artifacts.require("VenusFoldStrategyV2Mainnet_XVS");


// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("BSC Mainnet Venus XVS", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IBEP20.at("0xcF6BB5389c92Bdda8a3747Ddb454cB7a64626C63");
    ...
    it("Farmer should earn money", async function() {
      ...
      for (let i = 0; i < hours; i++) {
        ...
        if (i>0) {
          ...
          console.log("Intended withdraw amount:", correspondingFarmerBalance.toFixed(), "XVS");
          ...
          console.log("Actual withdraw amount:  ", farmerBalance.minus(oldFarmerBalance).toFixed(), "XVS");
          ...
          console.log("New farmer balance:      ", farmerBalance.toFixed(), "XVS");
          console.log("------------------------");
        }
