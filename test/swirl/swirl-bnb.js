...
const Strategy = artifacts.require("SwirlLPStrategyMainnet");


// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("BSC Mainnet Swirl SWIRL/BNB", function() {
  let accounts;
  ...
  let swirlAddr = "0x52d86850bc8207b520340B7E39cDaF22561b9E56";
  ...
  async function setupExternalContracts() {
    underlying = await IBEP20.at("0x135AeDCFb35b0b5dCf61Db7891a21253452Eb970");
