...
const Strategy = artifacts.require("SpaceStrategy_SPACE_BNB");


// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("BSC Mainnet Space SPACE/BNB", function() {
  let accounts;
  ...
  async function setupExternalContracts() {
    underlying = await IBEP20.at("0x78D9a0c50F6484291b4122f61888Bb9EE71879Ff");
  ...
  before(async function() {
    ...
    await feeForwarder.setConversionPath(spaceAddr, eth, [spaceAddr, wbnb, eth], {from:governance});
