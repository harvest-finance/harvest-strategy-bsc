...
const Strategy = artifacts.require("IronStrategyMainnet_IRON_BUSD");


// Vanilla Mocha test. Increased compatibility with tools that integrate Mocha.
describe("BSC Mainnet Value IRON/BUSD", function() {
  let accounts;
  // external contracts
  let underlying;
  ...
  let token1Addr = "0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56";
  ...
  async function setupExternalContracts() {
    underlying = await IBEP20.at("0x09D6afB74E3a40b24425EE215fA367be971b4aF3");
  ...
  async function setupBalance(){
    ...
    await swapBNBToTokenValue(farmer1, token0Addr, [bnbbusdLP, underlying.address], "50" + "000000000000000000");
    farmerToken0Balance = await token0.balanceOf(farmer1);
    await swapBNBToToken(farmer1, [wbnb, token1Addr], "50" + "000000000000000000", true);
  ...
  before(async function() {
    ...
    [controller, vault, strategy] = await setupCoreProtocol({
      ...
      "liquidationPath": [token1Addr, wbnb, eth],
    });
